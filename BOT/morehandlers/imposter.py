...
from BOT.db.imposter_db import (
    add_userdata,
    usr_data,
    get_userdata,
    check_imposter,
...
from BOT.config import COMMAND_HANDLER
from BOT.helper.status import user_admin
...
async def set_mataa(_, message: Message):
    ...
    if message.command[1] == "on":
        ...
        await message.reply("/imposter on/off** - Turn On The Watcher For Your Group Which Notifies About User Who Change Name or Username")
